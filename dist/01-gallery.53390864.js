...
const makeGalleryItemsMarkup = (galleryitems)=>galleryitems.map(({ preview , original , description  })=>` <a class="gallery__item" href="${original}">
...
const itemsMarkup = makeGalleryItemsMarkup((0, _galleryItems.galleryItems));
